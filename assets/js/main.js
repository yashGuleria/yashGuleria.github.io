...
document.addEventListener("DOMContentLoaded", function () {
  var links = document.querySelectorAll(".header-links .link");
  ...
  // Activates the last section whose top has scrolled above the reference
  // line, so short sections (e.g. a brief final section) still get picked up.
